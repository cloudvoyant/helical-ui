<!-- libs/helical-svelte/src/listbox/Listbox.svelte -->
<!-- Closely based on: Ark UI listbox (@ark-ui/svelte/listbox), mirrored from @cloudvoyant/helical-react. -->
...
<script lang="ts">
  ...
  import { listboxRootBase, cn, type ListboxItemData } from '@cloudvoyant/helical-ui';
