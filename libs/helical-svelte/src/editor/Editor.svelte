<script lang="ts">
  ...
  // Mirror helical-ui's placement helpers locally because this package's editor source is checked
  // before newly-built helical-ui declarations are always available in workspace tooling.
