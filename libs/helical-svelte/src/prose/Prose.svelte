<!-- libs/helical-svelte/src/prose/Prose.svelte -->
<!-- Closely based on: Shark UI prose, mirrored from @cloudvoyant/helical-react -->
<script lang="ts">
  import type { Snippet } from 'svelte';
  import type { HTMLAttributes } from 'svelte/elements';
  import { proseVariants, cn } from '@cloudvoyant/helical-ui';
