// libs/helical-react/src/editor/LinkPreviewCard.tsx
// React parity of LinkPreviewCard.svelte. Renders the `bookmark` card, or a 16:9 `embed`.
// YouTube embeds prefer the helical YouTube facade (lazy, no iframe until interaction).
  ...
  if (type === 'embed') {
    ...
    return (
      <NodeViewWrapper as="div" data-type="link-preview" className="link-preview my-4">
        {videoId ? (
          // helical YouTube takes the full url and derives the id itself.
